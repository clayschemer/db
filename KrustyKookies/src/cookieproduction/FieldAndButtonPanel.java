...
public class FieldAndButtonPanel extends JPanel {
	 ...
	 *            The text fields.
	 */
	public FieldAndButtonPanel(String[] texts, JTextField[] fields, JButton[] buttons, ActionListener actHand) {
		...
		middle.setLayout(new GridLayout(buttons.length, 1));
...
//		setLayout(new BoxLayout(this, BoxLayout.X_AXIS));
		setLayout(new GridLayout(texts.length,3));
		add(left);
		add(right);
		add(middle);
